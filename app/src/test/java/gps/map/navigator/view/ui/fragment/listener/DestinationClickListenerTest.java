...
@PrepareForTest({DestinationClickListener.class})
public class DestinationClickListenerTest {
    ...
    public void receive_onClick_verify() {
        DestinationClickListener clickListener = new DestinationClickListener();
